...
try:
    input_df_from_file = pd.read_csv('../dataset/csv/correct_jaekwon_manipulated_data.csv', index_col='frame')
    process_squat_data_pipeline(input_df_from_file, '../dataset/csv/correct_jaekwon_final_output.csv')
